...
var BankApiService = /** @class */ (function () {
    function BankApiService(http) {
        this.http = http;
    }
    BankApiService.prototype.getBankData = function (city) {
        var url = 'https://vast-shore-74260.herokuapp.com/banks?city=' + city;
        return this.http.get(url);
    };
    BankApiService.ctorParameters = function () { return [
...
var BankSearchComponent = /** @class */ (function () {
    function BankSearchComponent(bankapi) {
    ...
    BankSearchComponent.prototype.ngOnInit = function () {
    ...
    BankSearchComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
    };
    // Table Helper Functions
    BankSearchComponent.prototype.fetchData = function (city) {
        var _this = this;
        this.showSpinner = true;
        this.dataSource = null;
        this.bankapi.getBankData(city).subscribe(function (data) {
            _this.showSpinner = false;
            _this.branchdata = data;
            _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.branchdata);
            _this.dataSource.paginator = _this.paginator;
            _this.populateSelectedCityMap();
        });
    };
    BankSearchComponent.prototype.populateSelectedCityMap = function () {
        var storageSelectionMap = JSON.parse(localStorage.getItem("selection-map"));
        for (var city in storageSelectionMap) {
            if (storageSelectionMap.hasOwnProperty(city)) {
                ...
                for (var key in storageSelectionMap[city]) {
                    this.selectionCityMap[city].select(storageSelectionMap[city][key]);
                }
            }
        }
    };
    BankSearchComponent.prototype.cityChanged = function (city) {
        if (!(this.selectedCity in this.selectionCityMap)) {
            this.selectionCityMap[this.selectedCity] = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_5__["SelectionModel"](true, []);
        }
        this.fetchData(city);
        var tableContainer = document.querySelector('.table-container');
        var webkitClipPath = { value: "circle(" + tableContainer.getBoundingClientRect().height / 2 + " at 50% 50%)" };
        var overlay = document.querySelector(".overlay");
        var tl = new gsap__WEBPACK_IMPORTED_MODULE_6__["TimelineMax"]();
    ...
    BankSearchComponent.prototype.isAllSelected = function () {
        var numSelected = this.selectionCityMap[this.selectedCity].selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    BankSearchComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
            this.selectionCityMap[this.selectedCity].clear() :
            this.dataSource.data.forEach(function (row) { return _this.selectionCityMap[_this.selectedCity].select(JSON.stringify(row)); });
        this.saveSelectionData();
    };
    BankSearchComponent.prototype.saveSelectionData = function () {
        var storageObj = {};
        for (var key in this.selectionCityMap) {
    ...
    BankSearchComponent.prototype.checkBoxClicked = function (row) {
        if (row) {
            this.selectionCityMap[this.selectedCity].toggle(JSON.stringify(row));
            this.saveSelectionData();
        }
    };
    BankSearchComponent.prototype.isCheckBoxSelected = function (row) {
        return this.selectionCityMap[this.selectedCity].isSelected(JSON.stringify(row));
    };
    BankSearchComponent.ctorParameters = function () { return [
...
var FavoriteBanksComponent = /** @class */ (function () {
    function FavoriteBanksComponent() {
        this.displayedColumns = ['ifsc', 'bank_id', 'branch', 'address', 'city', 'district', 'state', 'bank_name',];
    }
    FavoriteBanksComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        var tableContainer = document.querySelector('.table-container');
        var webkitClipPath = { value: "circle(" + tableContainer.getBoundingClientRect().height / 2 + " at 50% 50%)" };
        var overlay = document.querySelector(".overlay");
    };
    FavoriteBanksComponent.prototype.ngOnInit = function () {
        ...
        var overlay = document.querySelector(".overlay");
        var webkitClipPath = { value: "circle(10% at 50% 50%)" };
        var tl = new gsap__WEBPACK_IMPORTED_MODULE_4__["TimelineMax"]();
    ...
    FavoriteBanksComponent.prototype.getFavoritesFromStorage = function () {
        var list = [];
        var favorites = JSON.parse(localStorage.getItem("selection-map"));
        for (var key in favorites) {
            if (favorites.hasOwnProperty(key)) {
                favorites[key].forEach(function (element) {
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        var shorMoreButton = document.querySelector(".mat-icon");
    ...
    HeaderComponent.prototype.hideOptions = function (event) {
